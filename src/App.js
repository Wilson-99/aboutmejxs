...
<div className="conteudo">
      ...
      <img src={logo} className="App-logo" alt="logo" />
        ...
        Wilson Justino, estudante de informática, 4º ano de frequência, residente em Benguela/Lobito, com o nível de aventura e curiosidade elevado e com máxima vontade em ser perito no desenvolvimento web.
        
        </div>
        </div>    
  
        <p>
    Já criei um site com minimas funções, atractivo, responsivo ligada a base de dados e uma calculadora com HTML, CSS e JavaScript.
</p>
   <p>Conhecimento</p> 
    ...
    <div class="skill-container">
        <div class="skills back-end">60%</div> 
    </div>
    </div> 
        ...
        <div class="skill-container">
        <div class="skills front-end">75%</div> 
        </div>          
        </div>
        ...
        <br/><br/><br/>
<ul>
<a href="#"><b>Ir para o topo</b></a><br/><br/>
...
&nbsp;<span class="contact-info__telephone">+244931152640</span>
<br/>

    <span class="contact-info__icon icon-whatsapp"></span>
...
&nbsp;<span class="contact-info__telephone">+244931152640</span>  
        <br/>
        <a href="https://www.instagram.com/willson_justin/">
                                    <svg xmlns="" width="20" height="20" align="left" fill="blue" fillRule='currentColor' class="bi bi-instagram" viewBox="0 0 16 16">
        ...
        <a href="https://twitter.com/_willson9">
